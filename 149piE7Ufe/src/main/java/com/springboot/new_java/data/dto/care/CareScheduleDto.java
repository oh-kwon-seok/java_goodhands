...
public class CareScheduleDto {
    ...
    public CareScheduleDto(Long uid, String care_reserve_date, String care_real_date,String caregiver_id, String user_id, Long senior_uid,   User caregiver, User user, Senior senior, LocalDateTime created, LocalDateTime updated, LocalDateTime deleted,  String token, Boolean used) {
        this.uid = uid;
