...
public class DiseaseDto {
    ...
    public DiseaseDto(Long uid, String name,String code, String description,DiseaseCategory diseaseCategory, Long disease_category_uid,  String user_id,  String disease_checklist,  Boolean used, Boolean use_disease_checklist, Boolean use_chronic, String token) {
