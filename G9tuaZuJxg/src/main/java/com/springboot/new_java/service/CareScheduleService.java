...
public class CareScheduleService extends AbstractCacheableSearchService<CareSchedule, CareScheduleDto>{
    ...
    public CareSchedule performSave(CareScheduleDto careScheduleDto) {
        ...
        Optional<User> user = userRepository.findByUid(careScheduleDto.getUser_id());
        Optional<User> caregiver = userRepository.findByUid(careScheduleDto.getCaregiver_id());
        ...
        careSchedule.setUser(user.get());
        careSchedule.setCaregiver(caregiver.get());
    ...
    public CareScheduleDto convertToDto(CareSchedule careSchedule) {
        ...
        dto.setCaregiver(userRepository.findByUid(careSchedule.getCaregiver().getUid()).get());
