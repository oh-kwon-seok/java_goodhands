...
public class DiseaseService extends AbstractCacheableSearchService<Disease, DiseaseDto> {
    ...
    public Disease performSave(DiseaseDto diseaseDto) {
        ...
        Long userId = diseaseDto.getUser_id();
        ...
        disease.setUse_disease_checklist(diseaseDto.getUse_disease_checklist());
        disease.setUse_chronic(diseaseDto.getUse_chronic());
        disease.setDiseaseCategory(diseaseCategory);
        disease.setUser(user.get());
    ...
    public DiseaseDto convertToDto(Disease disease) {
        ...
        DiseaseCategory diseaseCategory = diseaseCategoryRepository.findByUid(disease.getDiseaseCategory().getUid());
        dto.setDisease_category_uid(disease.getDiseaseCategory().getUid());
        dto.setDiseaseCategory(diseaseCategory);
        dto.setUsed(disease.getUsed());
        dto.setUse_disease_checklist(disease.getUse_disease_checklist());
        dto.setDisease_checklist(disease.getDisease_checklist());
        dto.setDescription(disease.getDescription());
        dto.setUse_chronic(disease.getUse_chronic());
