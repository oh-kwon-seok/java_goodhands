...
public class CareLogDto {
    ...
    public CareLogDto(Long uid, String user_id,Long care_schedule_uid,String caregiver_checklist, String start_time,String end_time, Boolean used, String token) {
