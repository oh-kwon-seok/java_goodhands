...
public class UserDto {
    ...
    public UserDto(String id, Long employment_uid, Long department_uid, String password, String name, String email, String phone, String auth, Long used, String token, Map<String, Permission> menu, Department department, Employment employment, LocalDateTime created) {
        this.id = id;
