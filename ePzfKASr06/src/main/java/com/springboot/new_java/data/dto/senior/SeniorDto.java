...
public class SeniorDto {
    ...
    public SeniorDto(Long uid, Long user_id,String name, String birth_date,Long caregiver_id,User user,User caregiver,String care_schedule_protocol,Long care_home_uid,Boolean use_care_schedule, List<Map<String, Object>> senior_disease, LocalDateTime created,   Boolean used, String token) {
        this.uid = uid;
